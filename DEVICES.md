...
| `AAC1UKZ01` | HS-25VRB03 | 175-byte extended-36 | ❌ | Module `MK-QTWiFi3.1S`, firmware `e.4.3.00` / `R_6.0.01`, Malaysia. The extended-36 map with five further words of counters on the end. Decode cross-checked against the unit's own published values, including both vane positions; awaiting the owner's confirmation on hardware. |
